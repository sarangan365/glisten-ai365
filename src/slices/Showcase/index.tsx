...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    ...
    >
      ...
      />
      <div
        className="mt-16 grid items-center rounded-xl border
      border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 
      backdrop-blur-sm lg:grid-cols-3 lg:py-12"
      >
        <div>
